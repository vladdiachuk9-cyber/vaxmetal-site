...
export function ContentPageCta() {
  ...
  return (
    <div className="mt-16 flex flex-col items-start justify-between gap-6 rounded-xl border border-border bg-navy p-8 text-white sm:flex-row sm:items-center">
      <div>

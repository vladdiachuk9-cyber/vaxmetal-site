  ...
  return (
    ...
    >
      <body className="flex min-h-full flex-col bg-background text-foreground">
        {/*
          Per node_modules/next/dist/docs/.../script.md for this Next version:
          beforeInteractive scripts must be inside <body> (as a child, not a
          sibling of it under <html>) — Next hoists them into <head> itself
          regardless of position. Placing it as an <html> sibling (the literal
          reading of "as high as possible in <head>") is invalid JSX here and
          produced a real hydration error (<script> cannot be a child of
          <html>), confirmed in the dev server log.
        */}
